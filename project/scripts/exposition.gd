...
const dialog_lines: Array[String] = [
	"Narrator: In een verre, kleurige wereld genaamd ArithmeRealm leven de Bloblems: ronde, stuiterende wezentjes die alles eten… zolang het maar het goede antwoord op hun rekensom is. ",
	"Narrator: Elke Bloblem heeft een som op zijn buik – 7 + 5, 9 − 3, 4 × 6 – en als ze niet het juiste antwoord krijgen, worden ze chagrijnig, sloom en uiteindelijk steenhard. ",
	"Narrator: Zonder vrolijke Bloblems stopt de hele wereld met draaien.",
	"Narrator: Ooit was ArithmeRealm een plek waar rekenen vanzelf ging. De getallen zweefden door de lucht, de sommen klopten altijd, en de Bloblems waren blij en actief.",
	...
	"Narrator: Overal waar ze komen, raken de Bloblems in de war: hun sommen veranderen, antwoorden verdwijnen, en niemand weet nog wat klopt.",
	...
	"Narrator: In het boek stond een simpele som… tot de cijfers opeens van de bladzijde sprongen en een poort vormden. Je belandt in ArithmeRealm, recht voor de Ranch: een soort veilige basis waar vriendelijke Bloblems bij elkaar wonen.",
